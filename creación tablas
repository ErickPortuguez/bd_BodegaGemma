...
CREATE TABLE reserva (
    ...
    fecha_reserva TIMESTAMP NOT NULL,                             -- Fecha y hora en la que se hace la reserva
    cantidad_producto integer NOT NULL,                           -- Cantidad del producto reservado
    ...
    CONSTRAINT reserva_product_fk FOREIGN KEY (product_id) REFERENCES product (id), -- Relación con la tabla product
